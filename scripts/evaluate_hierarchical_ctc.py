...
def run_hierarchical_evaluation(
    ...
    num_workers=4,
    device=None,
    num_attention_visualizations=5
    ):
    ...
    attention_viz_dir = os.path.join(output_dir, "attention_visualizations_eval")
    ...
    with torch.no_grad():
        ...
        for batch_idx, batch in enumerate(progress_bar):
            ...
            try:
                ...
                original_images_pil_batch = batch.get('original_images_pil')
                ...
                should_return_attention = (
                    ...
                    len(original_images_pil_batch) == current_batch_size_actual 
                )
    ...
    std_viz_dir = os.path.join(output_dir, "visualizations")
    diacritic_viz_path = visualize_diacritic_accuracy(diacritic_results, std_viz_dir)
    ...
    _ = generate_visualizations(df_results, std_viz_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_attention_visualizations", type=int, default=5, help="Number of samples to generate attention visualizations for")
    ...
    run_hierarchical_evaluation(
        ...
        num_attention_visualizations=args.num_attention_visualizations
    )