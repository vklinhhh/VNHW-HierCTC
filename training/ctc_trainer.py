    ...
    if start_epoch > 0 and use_amp:
        ...
        if os.path.exists(potential_checkpoint_path):
            try:
                ...
                checkpoint = torch.load(potential_checkpoint_path, map_location='cpu') 
